...
for k = 1 : nWords
    ...
    wordsInvers(k) = string(word);
     
 end

wordsInvers = wordsInvers';


save('variables', 'alphabet', 'dictionary', 'nKeys', 'nTestSet', 'nTrainSet', 'nWords', ...
    'testSet', 'trainSet', 'valueSet', 'words', 'wordsInvers');
